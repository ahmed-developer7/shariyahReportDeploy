...
(function ($) {
  $.fn.easySelect = function (options) {
    ...
    $.fn.easySelect1 = function (options) {
        return this.each(function () {
            var settings = $.extend(
                {
                    search: false,
...
$("#demo123").easySelect1({
    buttons: false,
    search: false,
    placeholder: "Remove Previously Selected Auditors",
    placeholderColor: "#524781",
    selectColor: "#524781",
    itemTitle: "Countrys selected",
    showEachItem: true,
...
$("#demo456").easySelect1({
    buttons: false,
    search: false,
    placeholder: "Choose More Auditors",
    placeholderColor: "#524781",
    selectColor: "#524781",
    itemTitle: "Countrys selected",
    showEachItem: true,
...
$("#demo5").easySelect1({
    buttons: false,
    search: false,
    placeholder: "Remove Previously Selected Audit Dates",
    placeholderColor: "#524781",
    selectColor: "#524781",
    itemTitle: "Countrys selected",
    showEachItem: true,
