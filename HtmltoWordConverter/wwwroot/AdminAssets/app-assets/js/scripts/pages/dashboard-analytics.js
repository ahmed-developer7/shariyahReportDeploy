...
$(window).on("load", function () {
  ...
  radialDangerChart.render();
    ...
    // Radial-Success-chart1
    // --------------------------------
    var radialSuccessoptions1 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar"
    ...
    var radialSuccessChart1 = new ApexCharts(
        document.querySelector("#radial-success-chart1"),
        radialSuccessoptions1
    );

    radialSuccessChart1.render();

    // Radial-Warning-chart
    // --------------------------------
    var radialWarningoptions1 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar"
    ...
    var radialWarningChart1 = new ApexCharts(
        document.querySelector("#radial-warning-chart1"),
        radialWarningoptions1
    );

    radialWarningChart1.render();

    // Radial-Danger-chart
    // --------------------------------
    var radialDangeroptions1 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var radialDangerChart1 = new ApexCharts(
        document.querySelector("#radial-danger-chart1"),
        radialDangeroptions1
    );

    radialDangerChart1.render();
  ...
  profitInfoChart.render();
    ...
    // Profit Primary Chart 1
    // --------------------------------
    var profitPrimaryOptions1 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var profitPrimaryChart1 = new ApexCharts(
        document.querySelector("#profit-primary-chart1"),
        profitPrimaryOptions1
    );

    profitPrimaryChart1.render();


    // Profit Info Chart 1
    // --------------------------------
    var profitInfoOptions1 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var profitInfoChart1 = new ApexCharts(
        document.querySelector("#profit-info-chart1"),
        profitInfoOptions1
    );

    profitInfoChart1.render();
    ...
    // Profit Primary Chart 2
    // --------------------------------
    var profitPrimaryOptions2 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var profitPrimaryChart2 = new ApexCharts(
        document.querySelector("#profit-primary-chart2"),
        profitPrimaryOptions2
    );

    profitPrimaryChart2.render();


    // Profit Info Chart 2
    // --------------------------------
    var profitInfoOptions2 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var profitInfoChart2 = new ApexCharts(
        document.querySelector("#profit-info-chart2"),
        profitInfoOptions2
    );

    profitInfoChart2.render();




    // Profit Primary Chart 3
    // --------------------------------
    var profitPrimaryOptions3 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var profitPrimaryChart3 = new ApexCharts(
        document.querySelector("#profit-primary-chart3"),
        profitPrimaryOptions3
    );

    profitPrimaryChart3.render();


    // Profit Info Chart 1
    // --------------------------------
    var profitInfoOptions3 = {
        chart: {
            height: 40,
            width: 40,
            type: "radialBar",
    ...
    var profitInfoChart3 = new ApexCharts(
        document.querySelector("#profit-info-chart3"),
        profitInfoOptions3
    );

    profitInfoChart3.render();
  ...
  var registrationChartoptions = {
    ...
    states: {
      ...
      colors: [$danger_light, $danger_light, $danger_light, $danger_light, $warning, $danger_light, $danger_light, $danger_light, $danger_light],
    series: [{
      name: 'Sessions',
      data: [3, 7, 5,8, 15, 11, 12,6,3]
    }],
    grid: {
      show: false,
      padding: {
